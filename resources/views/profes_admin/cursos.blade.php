...
<div class=row>
    ...
    <div class="container demo m-top">
        <div class="text-left m-4 row" style="background: #b50045;">
            ...
            <button value="{{$departamento['id']}}" class="borrarDepartamento btn icon-btn btn-light d-inline col-md-2" style="background-color: white; color:black; margin-top: 1em;">
                <span class="glyphicon glyphicon-plus"></span>
                Borrar Departamento
            </button>
