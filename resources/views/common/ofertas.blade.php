      ...
      <div >
        ...
        <td class="td-actions">
          <button class="btn btn-default btn-xs" style="float:right;" data-toggle="modal" href="#myModal" data-target="#edit-modal-cust-<?php echo $oferta->id;?>"
            ...
            <button data-toggle="modal" data-target="#delete-modal-cust-<?php echo $oferta->id;?>" class="  btn btn-default btn-xs " style="background: #b50045; color:white;">
...
<div id="delete-modal-cust-<?php echo $oferta->id;?>" class="modal" >
  ...
  <center><button class=" borrarOferta btn btn-default btn-xl" style="background: #b50045; color:white;" value="{{$oferta['id']}}">
      <span class="glyphicon glyphicon-remove" ></span> @lang('header.borrar')
</button></center>
